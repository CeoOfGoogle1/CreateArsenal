...
public class ProximityFuseItem extends Item implements IAdditionalCreativeItems {
    public ProximityFuseItem(Properties properties) {
        super(properties);
    }
