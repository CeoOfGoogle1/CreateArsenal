...
public class FourBarrelStaticTurretRenderer extends KineticTileEntityRenderer {
    public FourBarrelStaticTurretRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
